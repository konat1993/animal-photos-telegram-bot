  ...
  const focusReportOnMap = useCallback(
    (reportId: string) => {
      ...
      requestAnimationFrame(() => {
        document.getElementById("sighting-map")?.scrollIntoView({
          behavior: "smooth",
          block: "start",
        });
      });
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="min-w-40 max-w-56">Place</TableHead>
              ...
              {reports.map((report) => (
                <TableRow
                  ...
                  onClick={(e) => {
                    ...
                    if (
                      ...
                      isNonEmptySelectionInsideRow(row)
                    ) {
                      return;
                    }
                    const t = e.target;
                ...
                >
                  ...
                  <TableCell className="max-w-56 text-sm text-muted-foreground">
                    {(() => {
                      const place = formatReportLocation(report);
                      return place ? (
                        <span className="line-clamp-2" title={place}>
                          {place}
                        </span>
                      ) : (
                        "—"
                  ...
                  >
                    {report.photo_url ? (
                      <button
                        ...
                        onClick={() => openReportPhoto(report.id)}
                      >
                        View
                      </button>
                    ) : (
